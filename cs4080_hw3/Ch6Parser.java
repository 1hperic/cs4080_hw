...
//< Statements and State expression
    return comma();
    //return conditional; for chapter 6 problem 2
  }
  ...
  /* chapter 6 problem 2 implementation
...
//< check-max-arity
        arguments.add(equality()); //formerly arguments.add(expression());
      } while (match(COMMA));
    }
...
//< primary-error
    ...
    // chapter 6 problem 3 implementation
    if (match(PLUS, MINUS, STAR, SLASH, BANG_EQUAL,
